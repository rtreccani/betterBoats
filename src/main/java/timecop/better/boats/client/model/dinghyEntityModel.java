...
public class dinghyEntityModel extends EntityModel<dinghyEntity>{
    ...
    @Override
    public void setAngles(dinghyEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch){
    //why the fuck did i need to type this REEEEE   
    }
