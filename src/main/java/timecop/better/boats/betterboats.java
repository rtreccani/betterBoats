...
public class betterboats implements ModInitializer {
    ...
    // public static final Item DINGHY_ITEM = new Item(new
    // Item.Settings().group(ItemGroup.TRANSPORTATION));
    // public static final

    public static final EntityType<dinghyEntity> DINGHY = Registry.register(Registry.ENTITY_TYPE,
            new Identifier("betterboats", "dinghy_entity"), FabricEntityTypeBuilder
                    .create(SpawnGroup.MISC, dinghyEntity()).dimensions(EntityDimensions.fixed(10.0f, 10.0f)).build());
